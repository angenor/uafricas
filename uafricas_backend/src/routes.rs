        ...
        web::scope("/api")
            ...
            .service(
                web::scope("/admin")
                    ...
                    // AfroLang - Propositions de salles (feature 005, US2)
                    .route("/afrolang/propositions", web::get().to(admin::propositions_afrolang::lister_propositions))
                    .route("/afrolang/propositions/{id}", web::get().to(admin::propositions_afrolang::obtenir_proposition))
                    .route("/afrolang/propositions/{id}/approuver", web::post().to(admin::propositions_afrolang::approuver_proposition))
                    .route("/afrolang/propositions/{id}/refuser", web::post().to(admin::propositions_afrolang::refuser_proposition))
                    // AfroLang - Modérateurs attitrés (feature 005, US3)
            ...
            .service(
                web::scope("/afrolang")
                    ...
                    // Propositions (feature 005, US2) — routes statiques AVANT /salles/{id}
                    .route("/salles/propositions", web::post().to(afrolang::creer_proposition))
                    .route("/salles/propositions/mine", web::get().to(afrolang::lister_mes_propositions))
                    // Salles publiques
                    ...
                    // Visibilité / limite / adhésions / invitations (feature 005, US5)
                    .route("/salles-privees/{id}/visibilite", web::patch().to(afrolang::changer_visibilite_salle_privee))
                    .route("/salles-privees/{id}/max-participants", web::patch().to(afrolang::modifier_max_participants_salle_privee))
                    .route("/salles-privees/{id}/demandes", web::post().to(afrolang::demander_adhesion))
                    .route("/salles-privees/{id}/invitations", web::post().to(afrolang::inviter_membre))
                    .route("/salles-privees/{id}/adhesions", web::get().to(afrolang::lister_adhesions_salle_privee))
                    .route("/adhesions/{id}/decision", web::patch().to(afrolang::decision_adhesion))
                    .route("/adhesions/{id}", web::delete().to(afrolang::retirer_abonne))
