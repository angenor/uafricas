        ...
        web::scope("/api")
            ...
            .service(
                web::scope("/admin")
                    ...
                    .route("/engagement/actions-disponibles", web::get().to(admin::engagement::actions_disponibles))
                    .route("/engagement/regles", web::get().to(admin::engagement::lister_regles))
                    .route("/engagement/regles", web::post().to(admin::engagement::creer_regle))
                    .route("/engagement/regles/{id}", web::put().to(admin::engagement::modifier_regle))
                    .route("/engagement/regles/{id}", web::delete().to(admin::engagement::supprimer_regle))
                    .route("/engagement/categories", web::get().to(admin::engagement::lister_categories))
                    .route("/engagement/categories", web::post().to(admin::engagement::creer_categorie))
                    .route("/engagement/categories/{id}", web::put().to(admin::engagement::modifier_categorie))
                    .route("/engagement/categories/{id}", web::delete().to(admin::engagement::supprimer_categorie))
                    ...
                    .route("/engagement/niveaux", web::post().to(admin::engagement::creer_niveau))
                    .route("/engagement/niveaux/{id}", web::put().to(admin::engagement::modifier_niveau))
                    .route("/engagement/niveaux/{id}", web::delete().to(admin::engagement::supprimer_niveau))
                    .route("/engagement/badges", web::get().to(admin::engagement::lister_badges))
                    .route("/engagement/badges", web::post().to(admin::engagement::creer_badge))
                    .route("/engagement/badges/{id}", web::put().to(admin::engagement::modifier_badge))
            ...
            .service(
                web::scope("/engagement")
                    ...
                    .route("/mes-categories", web::get().to(engagement::mes_categories))
            ...
            // Statistiques agregees Mindshiftlab (bande d'accueil /universite)
            .service(
