...
pub struct FichePaysRow {
    ...
    // Symboles nationaux enrichis (schéma 11l)
...
pub struct FichePaysDetailResponse {
    ...
    pub hymne_national: Option<String>,
    // Notices des symboles nationaux (schéma 11l). Toutes facultatives : la
    // fiche n'affiche un symbole que s'il est réellement renseigné.
    pub drapeau_description: Option<String>,
    pub embleme_description: Option<String>,
    pub hymne_description: Option<String>,
    pub fleur_nationale: Option<String>,
