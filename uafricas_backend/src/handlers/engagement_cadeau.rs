...
pub(crate) fn source_titre(type_objet: &str) -> Option<(&'static str, &'static str)> {
    match type_objet {
        ...
        "emission_tele" => Some(("media_content.emission_tele", "titre")),
        "emission_radio" => Some(("media_content.emission_radio", "titre")),
        "episode_tele" => Some(("media_content.episode_tele", "titre")),
        "episode_radio" => Some(("media_content.episode_radio", "titre")),
