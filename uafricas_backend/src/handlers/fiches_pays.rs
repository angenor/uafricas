...
async fn construire_detail_response(
    ...
    Ok(FichePaysDetailResponse {
        ...
        drapeau_description: row.drapeau_description.clone(),
        embleme_description: row.embleme_description.clone(),
        hymne_description: row.hymne_description.clone(),
        fleur_nationale: row.fleur_nationale.clone(),
        fleur_description: row.fleur_description.clone(),
        animal_national: row.animal_national.clone(),
        animal_description: row.animal_description.clone(),
        oiseau_national: row.oiseau_national.clone(),
        oiseau_description: row.oiseau_description.clone(),
