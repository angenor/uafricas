...
- La spécification passe tous les critères de qualité sans clarification nécessaire.
- Les hypothèses documentées couvrent les décisions raisonnables prises par défaut (hébergement externe, format de stockage, langues, précision timestamps).
