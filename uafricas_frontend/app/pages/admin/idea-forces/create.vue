      ...
      <div class="card-body">
        ...
        <form @submit.prevent="soumettre" class="space-y-4">
          ...
          <div class="form-control">
            ...
            <textarea v-model="form.details_proposition" class="textarea textarea-bordered" rows="4" required placeholder="Détails techniques et pratiques de la proposition..." />
          </div>
