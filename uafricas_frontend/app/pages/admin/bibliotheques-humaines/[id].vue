...
async function confirmerRejet() {
  actionLoading.value = true
  try {
    await rejeterDemande(id, commentaireRejet.value.trim() || undefined)
...
<template>
  <div>
    ...
    <div class="text-sm breadcrumbs mb-4">
      <ul>
        <li><NuxtLink to="/admin/bibliotheques-humaines">Bibliothèques Humaines</NuxtLink></li>
    ...
    <template v-else-if="demandeDetail">
        ...
        <div class="card-body">
          <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-base-content/80 text-sm">{{ demandeDetail.fonction }}</p>
            ...
            <div class="flex gap-2 flex-shrink-0">
              ...
              >
                ...
                {{ demandeDetail.statut === 'valide' ? 'Révoquer' : 'Rejeter' }}
              </button>
              <button
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
              <h2 class="card-title text-base">Spécialités</h2>
              <div class="flex flex-wrap gap-2">
                ...
                >{{ s }}</span>
                <span v-if="demandeDetail.specialites.length === 0" class="text-base-content/50 text-sm">
          ...
          <div v-if="demandeDetail.commentaireAdmin" class="alert alert-error">
            ...
            <div>
              <p class="font-semibold text-sm">Motif du rejet</p>
        ...
        <div class="space-y-4">
          <div class="card bg-base-100 shadow-sm">
            <div class="card-body gap-3">
              ...
              <div v-if="demandeDetail.traiteLe">
                <p class="text-xs text-base-content/50 uppercase tracking-wide font-semibold mb-0.5">Traité le</p>
                <p class="text-sm">{{ formatDate(demandeDetail.traiteLe) }}</p>
              </div>
              <div v-if="demandeDetail.traiteParNom">
    ...
    <!-- Modal rejet/révocation -->
    <Teleport to="body">
      <div v-if="showRejetModal" class="modal modal-open">
        <div class="modal-box max-w-md">
          <h3 class="font-bold text-lg mb-1">
            {{ demandeDetail?.statut === 'valide' ? 'Révoquer la validation' : 'Rejeter la demande' }}
          </h3>
          <p class="text-base-content/70 text-sm mb-4">
            Vous pouvez laisser un commentaire pour expliquer le motif.
