...
const { creer, loading, error } = useAdminDomaines()
const router = useRouter()
const form = reactive({ nom: '', description: '', icone: '' })
const erreurLocale = ref<string | null>(null)
const soumettre = async () => {
  erreurLocale.value = null
  if (!form.nom.trim()) { erreurLocale.value = 'Le nom du domaine est requis'; return }
  try {
...
<template>
  <div>
    <AdminPageHeader titre="Nouveau domaine" sous-titre="Ajouter un domaine ou secteur d'activite">
    ...
    <div class="card bg-base-100 shadow-sm">
      <div class="card-body">
        ...
        <form @submit.prevent="soumettre" class="space-y-4">
          ...
          <div class="form-control"><label class="label"><span class="label-text">Icone</span></label><input v-model="form.icone" type="text" class="input input-bordered" placeholder="Ex: fa-globe, emoji..."></div>
          ...
          <div class="flex justify-end gap-2 pt-4">
            <NuxtLink to="/admin/domaines" class="btn btn-ghost">Annuler</NuxtLink>
