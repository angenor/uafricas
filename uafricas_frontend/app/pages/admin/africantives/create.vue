...
const { creer, loading, error } = useAdminAfricantives()
...
const soumettre = async () => {
  ...
  try {
    ...
    await creer(body)
    router.push('/admin/africantives')
  }
  catch (e: any) {
...
<template>
  <div>
    <AdminPageHeader titre="Nouvelle africantive" sous-titre="Ajouter une initiative africaine">
      <template #actions>
      ...
      <div class="card-body">
        ...
        <form @submit.prevent="soumettre" class="space-y-4">
          ...
          <div class="flex justify-end gap-2 pt-4">
            <NuxtLink to="/admin/africantives" class="btn btn-ghost">Annuler</NuxtLink>
