      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center px-4">
        <div class="flex items-center gap-3 mb-4 animate-fadeInUp">
          <div class="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
            <font-awesome-icon :icon="['fas', 'eye']" class="text-white text-xl" />
          </div>
        ...
        <div class="flex flex-wrap items-center justify-center gap-4 mt-8 animate-fadeInUp animation-delay-400">
          <div class="flex items-center bg-white/15 backdrop-blur-sm px-5 py-2.5 rounded-full border border-white/20">
            <font-awesome-icon :icon="['fas', 'file-lines']" class="text-cyan-300 mr-2" />
            <span class="text-white font-bold text-lg">{{ contributions.length }}</span>
            <span class="text-white/70 ml-2 text-sm">vérifications</span>
          </div>
          <div class="flex items-center bg-white/15 backdrop-blur-sm px-5 py-2.5 rounded-full border border-white/20">
            <font-awesome-icon :icon="['fas', 'earth-africa']" class="text-cyan-300 mr-2" />
          ...
          <div class="flex items-center bg-white/15 backdrop-blur-sm px-5 py-2.5 rounded-full border border-white/20">
            <font-awesome-icon :icon="['fas', 'circle-check']" class="text-green-300 mr-2" />
            <span class="text-white font-bold text-lg">{{ nombreVerifies }}</span>
            <span class="text-white/70 ml-2 text-sm">vérifiés</span>
          </div>
        </div>
      </div>
    </div>
