<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- Modal À propos -->
    <div v-if="afficherAPropos" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
...
.animate-subtitle {
  animation: fadeInDelay 1.5s ease-out 0.8s both;
}
</style>
