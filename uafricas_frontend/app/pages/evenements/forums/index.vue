<template>
  <div class="min-h-screen z-0">
    <!-- Hero -->
    <div class="h-64 w-full bg-font-baniere-ethnie flex relative bg-cover">
      <div class="absolute bottom-16 left-0 bg-custom-chocolat text-white w-screen text-center font-semibold text-3xl py-2 bg-opacity-50">
