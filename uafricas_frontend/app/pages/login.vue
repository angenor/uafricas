  ...
  >
    ...
    >
      ...
      >
        ...
        <ul class="space-y-1">
          <li><code class="bg-gray-100 px-1 rounded">test@uafricas.com</code></li>
          <li><code class="bg-gray-100 px-1 rounded">admin@uafricas.com</code></li>
          <li><code class="bg-gray-100 px-1 rounded">demo@uafricas.com</code></li>
        </ul>
        <p class="mt-2 text-xs text-gray-500">Mot de passe : n'importe quel texte (4+ caractères)</p>
      </div>
    </div>
  </div>
</template>
