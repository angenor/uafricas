...
const fonctionnalites = [
  {
    icone: 'users',
    titre: 'Communautés linguistiques',
    texte: 'Rejoignez une communauté par langue et échangez avec des locuteurs natifs.',
  },
  {
    icone: 'chalkboard-user',
    titre: 'Espaces d\'apprentissage',
    texte: 'Cours en ligne, ateliers de conversation, classes virtuelles et mentorat.',
  },
  {
    icone: 'book-open',
    titre: 'Bibliothèque linguistique',
    texte: 'Dictionnaires, grammaires, alphabets, ressources audio et vidéo.',
  },
  {
    icone: 'database',
    titre: 'Documentation des langues',
    texte: 'Collectez, vulgarisez et archivez les langues en danger.',
  },
]
