      ...
      >
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h3 class="font-display text-xl font-bold text-gray-900">Partager ce profil</h3>
            <button
              type="button"
              :disabled="enCours"
          ...
          <div class="px-6 py-5">
            <div v-if="succes" class="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p class="font-medium text-gray-900">Profil partagé dans la communauté !</p>
            ...
            <template v-else>
              ...
              <textarea
                ...
                rows="4"
                :maxlength="MAX"
                placeholder="Ex. : Un profil inspirant à découvrir !"
