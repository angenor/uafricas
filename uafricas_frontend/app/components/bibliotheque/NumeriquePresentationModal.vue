      ...
      >
        ...
        <div class="relative shrink-0 bg-linear-to-r from-custom-chocolat to-custom-chocolat/80 px-6 py-6 text-white">
          ...
          <div class="flex items-center gap-3">
            <div class="w-12 h-12 rounded-2xl bg-white/15 flex items-center justify-center shrink-0">
              <font-awesome-icon :icon="['fas', 'book-open']" class="w-6 h-6" />
            </div>
            <div>
              <h2 class="text-xl md:text-2xl font-bold leading-tight">Bibliothèque Numérique</h2>
              <p class="text-white/90 text-sm">Toute la connaissance sur l'Afrique, à portée de clic</p>
            </div>
          </div>
        </div>
        ...
        <div class="overflow-y-auto px-6 py-6 space-y-8">
          ...
          <p class="text-gray-700 leading-relaxed">
            <strong class="text-gray-900">NuMeTech</strong> rassemble les travaux qui font avancer
            la connaissance sur l'Afrique&nbsp;: mémoires, thèses, études, rapports et publications.
            L'idée est simple&nbsp;: rendre ces ressources
            <strong class="text-gray-900">faciles à trouver, à lire et à télécharger</strong>, pour que
            la recherche africaine et sur l'Afrique profite au plus grand nombre.
          </p>
          ...
          <div class="rounded-2xl bg-custom-green/5 border border-custom-green/15 p-5">
            ...
            <p class="text-gray-700 text-sm leading-relaxed">
              Élargir l'accès à la connaissance, valoriser la recherche africaine et sur l'Afrique,
              et faire circuler largement les savoirs stratégiques et les travaux de référence.
            </p>
          </div>
        </div>
...
const fonctionnalites = [
  {
    icone: 'file-lines',
    titre: 'Publier vos travaux',
    texte: 'Déposez mémoires, thèses, rapports, études et articles avec les informations sur l\'auteur.',
  },
  {
    icone: 'book-open',
    titre: 'Lire en ligne',
    texte: 'Consultez les documents directement depuis votre navigateur, sans rien installer.',
  },
  {
    icone: 'magnifying-glass',
    titre: 'Rechercher facilement',
    texte: 'Retrouvez la bonne ressource grâce à la recherche par titre et au filtre par type de document.',
  },
  {
    icone: 'download',
    titre: 'Télécharger',
    texte: 'Récupérez les fichiers lorsque l\'auteur l\'autorise.',
  },
]
