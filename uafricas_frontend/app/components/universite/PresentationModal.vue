        ...
        <div class="overflow-y-auto px-6 py-6 space-y-8">
          ...
          <div class="rounded-2xl bg-custom-green/5 border border-custom-green/15 p-5">
            ...
            <p class="text-gray-700 text-sm leading-relaxed">
              Développer massivement les compétences en Afrique, améliorer l'employabilité et la
              performance, et renforcer les capacités des organisations africaines.
            </p>
          </div>
        </div>
...
const fonctionnalites = [
  {
    ...
    titre: 'Vous former en ligne',
    texte: 'Cours structurés en chapitres et leçons, à votre rythme, avec suivi de progression.',
  },
  {
    icone: 'rocket',
    titre: 'Monter en compétences',
    texte: 'Gouvernance, innovation, IA, entrepreneuriat, développement économique et social.',
  },
]
