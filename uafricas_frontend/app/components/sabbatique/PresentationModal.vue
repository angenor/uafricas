      ...
      >
        ...
        <div class="overflow-y-auto px-6 py-6 space-y-8">
          ...
          <p class="text-af-corps leading-relaxed">
            ...
            heures ? <strong class="text-af-encre">Sabbafrica</strong> vous permet de les mettre
            <strong class="text-af-encre">au service d'organisations africaines</strong>, que vous
